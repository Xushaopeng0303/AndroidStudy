package com.xsp.library.view.progressbar;
...
public class AnimProgressBar extends View {
    ...
    public AnimProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        //获取xml属性
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.AnimProgressBar, 0, 0);
        backGroundColor = typedArray.getColor(R.styleable.AnimProgressBar_backGroundColor, Color.GRAY);
        barColor = typedArray.getColor(R.styleable.AnimProgressBar_barColor, Color.RED);
        drawable = typedArray.getDrawable(R.styleable.AnimProgressBar_drawable);
        halfDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_halfDrawableWidth, 35);
        halfDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_halfDrawableHeight, 35);
        drawableHeightOffset = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_drawableHeightOffset, 0);
        isRound = typedArray.getBoolean(R.styleable.AnimProgressBar_isRound, true);
        roundX = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_roundX, 20);
        roundY = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_roundY, 20);
        progress = typedArray.getInt(R.styleable.AnimProgressBar_progress, 0);
        max = typedArray.getInt(R.styleable.AnimProgressBar_max, 100);
        isSetBar = typedArray.getBoolean(R.styleable.AnimProgressBar_isSetBar, false);
        progressHeight = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_progressHeight, 30);
        progressHeightOffset = typedArray.getDimensionPixelSize(R.styleable.AnimProgressBar_progressHeightOffset, 0);
        refreshTime = typedArray.getInt(R.styleable.AnimProgressBar_refreshTime,100);
        animMode = typedArray.getInt(R.styleable.AnimProgressBar_animMode, ANIM_NULL);
        rotateRate = typedArray.getInt(R.styleable.AnimProgressBar_rotateRate, 10);
        rotateDegree = typedArray.getInt(R.styleable.AnimProgressBar_rotateDegree, 0);
        scaleMax = typedArray.getFloat(R.styleable.AnimProgressBar_scaleMax, 2);
        scaleMin = typedArray.getFloat(R.styleable.AnimProgressBar_scaleMin, 1);
        scaleRate = typedArray.getFloat(R.styleable.AnimProgressBar_scaleRate, 0.1f);
        gradientStartColor = typedArray.getColor(R.styleable.AnimProgressBar_gradientStartColor, Color.RED);
        gradientEndColor = typedArray.getColor(R.styleable.AnimProgressBar_gradientEndColor, Color.YELLOW);
        isGradient = typedArray.getBoolean(R.styleable.AnimProgressBar_isGradient,false);
        init();
    }
