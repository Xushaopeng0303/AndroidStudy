package com.xsp.library.view.switcher;
...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uncheckCircleWidth = optPixelSize(typedArray, R.styleable.SwitchButton_sb_uncheckcircle_width, dp2pxInt(1.5f));
        uncheckCircleOffsetX = dp2px(10);
        uncheckCircleRadius = optPixelSize(typedArray, R.styleable.SwitchButton_sb_uncheckcircle_radius, dp2px(4));
        checkedLineOffsetX = dp2px(4);
        checkedLineOffsetY = dp2px(4);
        shadowRadius = optPixelSize(typedArray, R.styleable.SwitchButton_sb_shadow_radius, dp2pxInt(2.5f));
        shadowOffset = optPixelSize(typedArray, R.styleable.SwitchButton_sb_shadow_offset, dp2pxInt(1.5f));
        shadowColor = optColor(typedArray, R.styleable.SwitchButton_sb_shadow_color, 0X33000000);
        uncheckColor = optColor(typedArray, R.styleable.SwitchButton_sb_uncheck_color, 0XffDDDDDD);
        checkedColor = optColor(typedArray, R.styleable.SwitchButton_sb_checked_color, 0Xff51d367);
        borderWidth = optPixelSize(typedArray, R.styleable.SwitchButton_sb_border_width, dp2pxInt(1));
        checkLineColor = optColor(typedArray, R.styleable.SwitchButton_sb_checkline_color, Color.WHITE);
        checkLineWidth = optPixelSize(typedArray, R.styleable.SwitchButton_sb_checkline_width, dp2pxInt(1f));
        checkLineLength = dp2px(6);
        int buttonColor = optColor(typedArray, R.styleable.SwitchButton_sb_button_color, Color.WHITE);
     ...
     * 绘制选中状态指示器
     */
    protected void drawCheckedIndicator(Canvas canvas, int color, float lineWidth, float sx, float sy,
                                        float ex, float ey, Paint paint) {
        paint.setStyle(Paint.Style.STROKE);
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (System.currentTimeMillis() - touchDownTime <= 300) {
                    ...
                    float eventXX = event.getX();
                    float fraction = eventXX / getWidth();
                    fraction = Math.max(0f, Math.min(1f, fraction));
            ...
            switch (animateState) {
                ...
                case ANIMATE_STATE_PENDING_DRAG: {
                    viewState.checkedLineColor = (int) argbEvaluator.evaluate(value,
                            beforeState.checkedLineColor, afterState.checkedLineColor
                    );
                    ...
                    viewState.checkStateColor = (int) argbEvaluator.evaluate(value,
                            beforeState.checkStateColor, afterState.checkStateColor
                    );
