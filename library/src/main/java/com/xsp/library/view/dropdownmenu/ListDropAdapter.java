 ...
 * @author Sam
 */
public class ListDropAdapter extends BaseAdapter {
    ...
    public ListDropAdapter(Context context, List<String> list) {
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                ...
                viewHolder.mText.setBackgroundResource(R.color.drop_down_item_check_bg);
            } else {
